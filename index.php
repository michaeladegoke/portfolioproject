...
<html lang="en">
    <head>
        ...
        <script src="https://use.fontawesome.com/releases/v6.1.0/js/all.js" crossorigin="
        anonymous"></script>
        <!-- Google fonts-->
    ...
    <body id="page-top">
        ...
        <nav class="navbar navbar-expand-lg navbar-dark bg-primary fixed-top" id="sideNav">
            <a class="navbar-brand js-scroll-trigger" href="#page-top">
                ...
                <span class="d-none d-lg-block"><img class="img-fluid img-profile
            ...
            <div class="collapse navbar-collapse" id="navbarResponsive">
                <ul class="navbar-nav">
                    ...
                    <li class="nav-item"><a class="nav-link js-scroll-trigger" href="#experience">
                        Experience</a></li>
                    <li class="nav-item"><a class="nav-link js-scroll-trigger" href="#education">
                        Education</a></li>
                    <li class="nav-item"><a class="nav-link js-scroll-trigger" href="#skills">
                        Skills</a></li>
                    <li class="nav-item"><a class="nav-link js-scroll-trigger" href="#interests">
                        Interests</a></li>
                    <li class="nav-item"><a class="nav-link js-scroll-trigger" href="#awards">
                        Awards</a></li>
                    <li class="nav-item"><a class="nav-link js-scroll-trigger" href="#projects">
                        Projects</a></li>
                </ul>
            </div>
        </nav>
        ...
        <div class="container-fluid p-0">
            ...
            <section class="resume-section" id="about">
                <div class="resume-section-content">
                    ...
                    <p class="lead mb-5">I am experienced in leveraging agile frameworks to 
            ...
            <div class="my-5">
                ...
                if(isset($_POST['submit'])){
                    if(isset($_POST['submit'])){
                     ...
                     if(empty($_POST['email'])){
                        ...
                        empty($phoneErr) && empty($bodyErr)){
                            $sql = "INSERT INTO portfolio_db (name, email, phone, body)
                ...
                ?>
                <h3>Send Us Message For Your Need</h3>
               ...
               <div class="mb-3">
                  ...
                  <div class="mb-3">
                    ...
                    <input type="mobile" class="form-control <?php echo $phoneErr ? 'is-invalid' : null ?>"
                     placeholder="Enter Your Mobile Number" name="phone" autocomplete="off">
                     <div class="invalid-feedback">
                      <?php echo $phoneErr; ?>
                    </div>
                    </div>
                  <div class="mb-3">
                    ...
                    <textarea class="form-control <?php echo $bodyErr ? 'is-invalid' : null ?>" 
                    type="text" name="body" placeholder="Send Us Message" autocomplete="off"></textarea>
                    <div class="invalid-feedback">
                      <?php echo $bodyErr; ?>
                    </div>
                  </div>
            ...
            <section class="resume-section" id="experience">
                <div class="resume-section-content">
                    ...
                    <div class="d-flex flex-column flex-md-row justify-content-between mb-5">
                        ...
                        <div class="flex-shrink-0"><span class="text-primary">March 2013 -
                             Present</span></div>
                    </div>
                    <div class="d-flex flex-column flex-md-row justify-content-between mb-5">
                        <div class="flex-grow-1">
                        ...
                        <div class="flex-shrink-0"><span class="text-primary">December 2011 - 
                            March 2013</span></div>
                    </div>
                    <div class="d-flex flex-column flex-md-row justify-content-between mb-5">
                        <div class="flex-grow-1">
                            ...
                            <p>Podcasting operational change management inside of workflows to
                                ...
                                Taking seamless key performance indicators offline to maximise
                                 ...
                                 Keeping your eye on the ball while performing a deep dive on
                                  ...
                                  to derive convergence on cross-platform integration.</p>
                        </div>
                        <div class="flex-shrink-0"><span class="text-primary">July 2010 - 
                    ...
                    <div class="d-flex flex-column flex-md-row justify-content-between">
                        ...
                        <div class="flex-shrink-0"><span class="text-primary">September 2008 -
                             June 2010</span></div>
                    </div>
                </div>
            </section>
            ...
            <section class="resume-section" id="education">
                <div class="resume-section-content">
                    ...
                    <div class="d-flex flex-column flex-md-row justify-content-between mb-5">
                        ...
                        <div class="flex-shrink-0"><span class="text-primary">August 2006 - 
                            May 2010</span></div>
                    </div>
                    <div class="d-flex flex-column flex-md-row justify-content-between">
                        <div class="flex-grow-1">
                        ...
                        <div class="flex-shrink-0"><span class="text-primary">August 2002 - 
                            May 2006</span></div>
                    </div>
                </div>
            </section>
            ...
            <section class="resume-section" id="interests">
                <div class="resume-section-content">
                    ...
                    <p>Apart from being a web developer, I enjoy most of my time being outdoors.
                         In the winter, 
                        I am an avid skier and novice ice climber. During the warmer months here
                         in Colorado, 
                        I enjoy mountain biking, free climbing, and kayaking.</p>
                    <p class="mb-0">When forced indoors, I follow a number of sci-fi and fantasy 
                        genre movies and television shows, I am an aspiring chef, and I spend a 
                        large
            ...
            <section class="resume-section" id="projects">
                <div class="resume-section-content">
                    ...
                    <div class="subheading mb-3">Projects Presently request For</div>
                    <div class="subheading mb-3">Workflow</div>
                    <table class="table table-striped">
                        <thead>
                          <tr>
                            ...
                            <th scope="col">Project Required</th>
                          </tr>
                        </thead>
                        <tbody>
